...
.defines(function() {
    EntitySlimeBlue = ig.Entity.extend({
        ...
        health: 4,
        maxHealth: 4,
        animSheet: new ig.AnimationSheet( 'media/slime-blue.png', 16, 16 ),
        
        canJump: false,
        proximity: 80,
        actionTimer: null,
        posBlueTile: {x: 0, y: 0},
        imageBlueTile: new ig.Image('media/blue-tile.png'),
        ...
        draw: function() {
            this.parent();
            this.imageBlueTile.draw( this.posBlueTile.x - ig.game.screen.x, this.posBlueTile.y - ig.game.screen.y );
        },
        ...
        readyJump: function() {
            ...
            */
            ...
            yPos -= ( ig.game.tileSize * 11 );
            for ( var i = 0; i < 30; i++ ) {
                yPos += ig.game.tileSize;
                
                // if a tile is found
                if ( ig.game.collisionMap.getTile( xPos, yPos ) ) {
                
                    // tell the entity to jump
                    this.canJump = true;
                    
                    // draw a blue square on the found tile
                    this.posBlueTile.x = xPos;
                    this.posBlueTile.y = yPos;
                    
                    /*
                    var moveToPoint = new MoveToPoint();
                    moveToPoint.setDestination( this.posBlueTile );
                    var velocity = moveToPoint.getVelocity( this.speed, this );
            ...
            // fire a bullet
            bullet.roation = this.gun.rotation;
            bullet.body.velocity.x = Math.cos(bullet.rotation) * this.BULLET_SPEED;
            bullet.body.velocity.y = Math.sin(bullet.rotation) * this.BULLET_SPEED;
            
            // rotate bullets on trajectory
    ...
    ig.EntityPool.enableFor( EntitySlimeBlue );
});