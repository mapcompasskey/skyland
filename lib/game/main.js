...
.defines(function(){
    ...
    GameStage = ig.Game.extend({
        ...
        loadLevel: function( data ) {
            ...
            // spawn slime
            ig.game.spawnEntity( EntitySlime, ( this.tileSize * 10 ), ( this.tileSize * 25 ) );
            ig.game.spawnEntity( EntitySlimeBlue, ( this.tileSize * 30 ), ( this.tileSize * 33 ) );
            
            // spawn player
            ig.game.spawnEntity( EntityPlayer, ( this.tileSize * 5 ), ( this.tileSize * 25 ) );
        },
